...
window.MobileContact = (function () {
    ...
    function run() {
        ...
        // Ensure we use AlumniMobileNav if available
        if (window.AlumniMobileNav) window.MobileNav = window.AlumniMobileNav;
